...
const Home = () => {
  return (
    <div className='w-screen'>
        <Navbar/>
        <section id='home' className="w-screen flex justify-between bg-gray-200 -mt-2">
            ...
            <div className="flex-1 h-[48rem] bg-gray-200 rounded-bl-full bg-recycle object-fill">
            </div>
        </section>
        <section id="whatWedo" className="flex justify-around w-full bg-ebe h-screen transform -translate-y-20">
        ...
        <section id="categories" className="bg-e1 w-full h-screen -translate-y-20">
        ...
        <section id="collector" className="w-full bg-ebe h-full transform -translate-y-20">
            <h1 className="text-4xl pt-7 text-center mb-100">COLLECTORS</h1>
            <div className='transform translate-x-700 mb-20'>
